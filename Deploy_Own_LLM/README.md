...
- **Port Mapping (`-p 4000:8080`)**: Maps port `4000` on your local machine to port `8080` inside the container. This allows you to access the OpenWebUI interface through your web browser.
...
![Model Setting](model_setting.png)
...
- **Port Conflicts**: If ports `11434` or `4000` are already in use, you can change the host port mappings (e.g., `-p 11435:11434` or `-p 4001:8080`).
